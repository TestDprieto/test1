...
angular.module('clmCoverageModelRuntime', ['vlocity', 'CardFramework', 'sldsangular', 'forceng',
...
// Controllers
require('./modules/clmCoverageModelRuntime/controller/ClmCoverageModelRuntimeController.js');
require('./modules/clmCoverageModelRuntime/controller/ClmCoverageModelController.js');
require('./modules/clmCoverageModelRuntime/controller/ClmNewTermConfigController.js');

// Factories
require('./modules/clmCoverageModelRuntime/factory/NotificationHandler.js');
require('./modules/clmCoverageModelRuntime/factory/ClmCoverageModelService.js');
require('./modules/clmCoverageModelRuntime/factory/ClmTermModalService.js');

// Directives
require('./modules/clmCoverageModelRuntime/directive/HideNotification.js');
require('./modules/clmCoverageModelRuntime/directive/ClmCoverageModelRuntimeCollapseHeight.js');


// Templates
require('./modules/clmCoverageModelRuntime/templates/templates.js');
},{"./modules/clmCoverageModelRuntime/controller/ClmCoverageModelController.js":2,"./modules/clmCoverageModelRuntime/controller/ClmCoverageModelRuntimeController.js":3,"./modules/clmCoverageModelRuntime/controller/ClmNewTermConfigController.js":4,"./modules/clmCoverageModelRuntime/directive/ClmCoverageModelRuntimeCollapseHeight.js":5,"./modules/clmCoverageModelRuntime/directive/HideNotification.js":6,"./modules/clmCoverageModelRuntime/factory/ClmCoverageModelService.js":7,"./modules/clmCoverageModelRuntime/factory/ClmTermModalService.js":8,"./modules/clmCoverageModelRuntime/factory/NotificationHandler.js":9,"./modules/clmCoverageModelRuntime/templates/templates.js":10}],2:[function(require,module,exports){
angular.module('clmCoverageModelRuntime').controller('ClmCoverageModelController',
    ['$scope', '$rootScope', 'ClmTermModalService', 'ClmCoverageModelService', 'NotificationHandler', 'ClmValidationHandlerService', function(
    $scope, $rootScope, ClmTermModalService, ClmCoverageModelService, NotificationHandler, ClmValidationHandlerService) {
    'use strict';
    ...
    var deleteTermErrorMsg = 'Error Deleting the Term';
    ...
    if ($rootScope.vlocity.customLabels && $rootScope.vlocity.customLabels.CLMDeleteTermError && $rootScope.vlocity.customLabels.CLMDeleteTermError[$rootScope.vlocity.userLanguage]) {
                   deleteTermErrorMsg = $rootScope.vlocity.customLabels.CLMDeleteTermError[$rootScope.vlocity.userLanguage];
                }
    ...
    $scope.getVersionData = function(versionId) {
        ...
        ClmCoverageModelService.getVersionData($scope,inputMap).then(function(result) {
    ...
    $scope.refreshList = function(type){
         ClmCoverageModelService.refreshList(type);
    }

    $scope.launchCoverageModal = function() {
            console.log('launching from service');

            ClmCoverageModelService.launchNewAttrModal($scope, 'getTermsForAddition');
        };

    $scope.launchNewTermModal = function() {
            console.log('launching from service');

            ClmCoverageModelService.launchNewTermModal($scope, 'getNewTermInstance');
       };
    ...
    $scope.addContractTerms = function(records, type) {
        ...
        if (type === 'TermSpec' && lst.length > 0) {
            ...
            ClmCoverageModelService.addContractTerms($scope, inputMap, 'TermSpec').then(function(data){
    ...
    $scope.deleteContractTerms = function(records, type) {
         ...
         if(termIds == null || termIds.length == 0){
            ...
            if ( lst.length > 0) {
                 console.log('add Terms');
                 inputMap.coverageIds = lst;
                 ClmCoverageModelService.deleteContractTerms($scope, inputMap, 'TermSpec');
            }
         }
     };
...
angular.module('clmCoverageModelRuntime').controller('ClmCoverageModelRuntimeController',
    ['$scope', '$rootScope', 'ClmCoverageModelService',  '$timeout', function(
    $scope, $rootScope, ClmCoverageModelService, $timeout) {
    'use strict';
    ...
    $scope.setAttr = function(row, index){
        ...
        $scope.updateContractTerms = function(action, value, code, termRecord){
           ...
           ClmCoverageModelService.invokeAction(action.updateContractTerms, $scope);
       ...
       $scope.addCoverage = function(coverage, index){
            ...
            parent.postMessage(message, lexOrigin);
            ClmCoverageModelService.invokeRemoteMethod($scope, $scope.quoteId, 'ContractTermRuntimeHandler', 'addChildLine', inputMap);
...
angular.module('clmCoverageModelRuntime').controller('ClmNewTermConfigController',
...
angular.module('clmCoverageModelRuntime').directive('clmCollapseCalcHeight', ['$timeout', function($timeout) {
    'use strict';
    return {
        restrict: 'A',
...
angular.module('clmCoverageModelRuntime').directive('hideNotification', function($rootScope, $timeout) {
    'use strict';
    return {
        restrict: 'A',
        link: function() {
...
angular.module('clmCoverageModelRuntime')
.factory('ClmCoverageModelService', ['$http', 'dataSourceService','$timeout', 'dataService', 'ClmTermModalService','ClmValidationHandlerService','NotificationHandler', '$q', '$rootScope',
...
angular.module('clmCoverageModelRuntime').factory('ClmTermModalService',
...
angular.module('clmCoverageModelRuntime').factory('NotificationHandler', [
