...
angular.module('campaignActions', ['vlocity', 'mgcrea.ngStrap', 'chart.js',
    'ngSanitize'
...
},{"./modules/campaignResults/controller/CampaignResultsController.js":2}],2:[function(require,module,exports){
angular.module('campaignResults').controller('CampaignResultsController', function(
    $scope, $sce, $rootScope) {
    'use strict';
    $scope.nameSpacePrefix = fileNsPrefix();
    $scope.labels = ["Responded", "Recieved", "Sent"];
    $scope.data = [3, 5, 10];
    console.log('hello');
});
},{}]},{},[1]);
