vlocity.cardframework.registerModule.controller('googleGaugeChartController', ['$scope', '$compile', '$filter', '$rootScope', function ($scope, $compile, $filter, $rootScope) {
    ...
    function drawChart() {
        ...
        //To Draw Chart
        chart = new google.visualization.Gauge(document.getElementById('GaugeChart_div'));
