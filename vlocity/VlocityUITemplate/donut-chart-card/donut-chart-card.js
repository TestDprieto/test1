vlocity.cardframework.registerModule.controller('googleDonutChartController', ['$scope', '$compile', '$filter', '$rootScope', function ($scope, $compile, $filter, $rootScope) {
    ...
    function drawChart() {
        ...
        setOptions();
        //To Draw Chart
        chart = new google.visualization.PieChart(document.getElementById('DonutChart_div'));
