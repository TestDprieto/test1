...
import { OMNIDEF } from './new4VBTLwcEnglish_def.js';
import tmpl from './new4VBTLwcEnglish.html';
import tmpl_nds from './new4VBTLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class new4VBTLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
