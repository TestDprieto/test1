...
import { OMNIDEF } from './digiCommerceWorkshopEnglish_def.js';
import tmpl from './digiCommerceWorkshopEnglish.html';
import tmpl_nds from './digiCommerceWorkshopEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class digiCommerceWorkshopEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
