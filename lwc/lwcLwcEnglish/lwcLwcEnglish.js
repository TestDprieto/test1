...
import { OMNIDEF } from './lwcLwcEnglish_def.js';
import tmpl from './lwcLwcEnglish.html';
import tmpl_nds from './lwcLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
