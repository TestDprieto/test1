...
import { OMNIDEF } from './newLwcEnglish_def.js';
import tmpl from './newLwcEnglish.html';
import tmpl_nds from './newLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class newLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
