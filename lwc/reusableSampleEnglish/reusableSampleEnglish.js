...
import { OMNIDEF } from './reusableSampleEnglish_def.js';
import tmpl from './reusableSampleEnglish.html';
import tmpl_nds from './reusableSampleEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class reusableSampleEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
