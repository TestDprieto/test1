...
import { OMNIDEF } from './custom1LwcEnglish_def.js';
import tmpl from './custom1LwcEnglish.html';
import tmpl_nds from './custom1LwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class custom1LwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
