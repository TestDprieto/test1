...
import { OMNIDEF } from './dcLwcEnglish_def.js';
import tmpl from './dcLwcEnglish.html';
import tmpl_nds from './dcLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dcLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
